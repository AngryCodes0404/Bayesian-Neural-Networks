...
for i in range(epoch, nb_epochs):
    ...
    for x, y in trainloader:
        ...
        cost_pred, err = net.fit(
            x,
            y,
            burn_in=(i % re_burn < burn_in),
    ...
    print(
        ...
        % (i, nb_epochs, cost_train[i], err_train[i]),
        end="",
    )
...
ax1.plot(
    range(0, nb_epochs, nb_its_dev),
    np.clip(cost_dev[::nb_its_dev], a_min=-5, a_max=5),
    "b-",
)
